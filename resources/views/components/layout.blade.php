      ...
      @auth
        <div class="flex-row my-3 my-md-0">
          ...
          <a href="/profile/{{ auth()->user()->username }}" class="mr-2">
              <img title="My Profile" data-toggle="tooltip" data-placement="bottom" style="width: 32px; height: 32px; border-radius: 16px" src="{{ asset(auth()->user()->avatar) }}" />
          </a>
          <a class="btn btn-sm btn-success mr-2" href="/posts/create">Create Post</a>
