<x-layout>
    <div class="container py-md-5 container--narrow">
        <div class="d-flex justify-content-between">
          <h2>{{ $post->title }}</h2>
          <span class="pt-2">
            <a href="/post/edit/{{ $post->slug }}" class="text-primary mr-2" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i></a>
        ...
        <p class="text-muted small mb-4">
          ...
          Posted by <a href="#">{{ $post->user->name }}</a> on {{ $post->created_at }}
        </p>
